              ...
              >
                ...
                <div className="col-span-1 md:col-span-3 flex justify-between md:justify-end items-center">
                  ...
                  <div className="flex items-center gap-4 sm:gap-6">
                    ...
                    <button 
  onClick={() => { if(window.confirm('Êtes-vous sûr de vouloir supprimer cet article ?')) removeFromCart(item.id); }}
  className="w-12 h-12 flex items-center justify-center text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-full transition-colors text-lg"
...
>
  ...
  className="w-full flex items-center justify-center gap-3 bg-brand-accent text-white py-5 rounded-full text-lg font-bold hover:bg-brand-accent/90 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 shadow-lg border-2 border-brand-accent"
>
  Procéder au paiement <ArrowRight className="w-6 h-6" strokeWidth={2.5} />
</button>
